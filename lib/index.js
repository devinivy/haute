...
exports.calls = (instanceName, manifest) => {
    ...
    return manifest.reduce((collector, bone) => {
        ...
        let argGroups = (typeof fullPlace === 'undefined') ? undefined : exports.normalizeExports(require(fullPlace), fullPlace);
        ...
        if (dirFiles) {
            ...
            RequireDir(module, place, {
                ...
                visit: (value, path) => {
                    ...
                    argGroups.push(exports.normalizeExports(value, path));
...
exports.normalizeExports = (exports, path) => {
