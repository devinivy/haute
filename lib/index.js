...
exports.calls = (instanceName, manifest) => {
    ...
    return manifest.reduce((collector, bone) => {
        ...
        const preProcess = (call) => {

            if (bone.preProcess) {
                call.args = bone.preProcess(call.args, Path.relative(bone.dirname, call.file), bone);
            }
        ...
        return collector.concat(preProcess({
            instanceName,
            file: fullPlace,
            place: bone.place,
            useFilename: null,
...
exports.defaults = { extensions: RequireDir.defaults.extensions };
